...
final은 초기화만 해야됨(무슨 값이든)

어떤 어노테이션 붙이냐면 RequiredArgsConstructor 붙여야 한다.

![20210703_180219](/assets/20210703_180219.png)

이걸 붙이면 생성자에 arg가 필요한 걸 다 주입해준다.


RequiredArgsConstructor  이건 초기화 되지 않은 애들을 생성자 호출시 초기화 해주라는 의미.
초기화 꼭 되야하는 애들을 파라미터 넣어서 초기화 해줌
