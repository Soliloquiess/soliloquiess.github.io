...
//this.host = "http://demo.initech.com/";
    ...
    var infoResult =httpRequest.result;

    this.log(infoResult);
    var 개인정보  ={}

    개인정보.성명 = httpRequest.URLDECODE(StrGrab(infoResult, '<input type="hidden" name="name"          value="', '">'));
    개인정보.주민등록번호 = StrGrab(infoResult, '<input type="hidden" name="jumin"         value="','">');
    개인정보.주소 = httpRequest.URLDECODE(StrGrab(infoResult, '<input type="hidden" name="addr"          value="','">'));
    개인정보.신청금액= httpRequest.URLDECODE(StrGrab(infoResult, '<input type="hidden" name="amount"        value="','">'));
    개인정보.담보계좌번호= httpRequest.URLDECODE(StrGrab(infoResult, '<input type="hidden" name="account"       value="','">' ));
    개인정보.대출금입금계좌= httpRequest.URLDECODE(StrGrab(infoResult, '<input type="hidden" name="inputaccount"  value="','">' ));
    개인정보.비밀번호= httpRequest.URLDECODE(StrGrab(infoResult, '<input type="hidden" name="pass"          value="', '">'));

    this.log("개인정보"+ JSON.stringify(개인정보)+"]");
