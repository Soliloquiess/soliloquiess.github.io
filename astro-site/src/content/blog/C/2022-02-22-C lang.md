...
category: "C"
tags: ["C"]
description: "include, stdio.h C 에서 using 지시문(directive)과 비슷한 일을 한다. 다른 파일에 구현한 함수나 변수를 사용할 수 있게 해줌.(다만, C 처럼 알아서 함수나 변수를 찾아주지는 않음.)…"
permalink: "study/2022/02/22/C-lang"
---
### #include, stdio.h
