...
### 이 노트에서의 위치
visual-verdict·QA 자동화 파이프라인에서 **"스크린샷을 어떻게 얻는가"의 하부 엔진**에 해당한다. AI가 만든 UI를 브라우저로 열어 캡처하고, 그 결과를 verdict로 판정하는 흐름의 기반 기술.
...
> trycua가 만든 오픈소스 **백그라운드 "컴퓨터-사용(computer-use)" 드라이버**. Browser Harness가 브라우저(CDP)에 국한되는 것과 달리, **네이티브 데스크톱 앱 전반**을 대상으로 한다. Claude Code native 기능도 OMC 플러그인도 아닌 외부 오픈소스 도구다.
