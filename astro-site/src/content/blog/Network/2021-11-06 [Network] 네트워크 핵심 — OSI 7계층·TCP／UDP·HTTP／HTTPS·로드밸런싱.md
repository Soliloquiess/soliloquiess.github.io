...
category: "Network"
tags: ["Network", "네트워크"]
description: "OSI 7계층, TCP 3·4-way handshake, 흐름·혼잡제어, UDP vs TCP, 대칭키·공개키·HTTPS 인증, TLS/SSL HandShake, 로드 밸런싱, Blocking/Non-blocking·Sync/Async까지 네트워크 면접 핵심 정리."
