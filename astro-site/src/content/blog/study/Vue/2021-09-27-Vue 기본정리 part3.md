...
category: "Vue"
tags: []
description: "에 background image : url() 이걸로 집어넣으면 됩니다. 인스타 포스팅 데이터 오늘은 인스타그램 프로젝트를 생성하고 메인페이지 레이아웃을 완성합시다. 새로운 프로젝트 생성은 작업폴더 오픈하시고 터미"
permalink: "2021/09/27/Vue-기본정리-part3"
---
<!-- ---
