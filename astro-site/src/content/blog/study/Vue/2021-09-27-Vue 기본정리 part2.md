...
category: "Vue"
tags: []
description: "이렇게 보여주려면 어떻게 코드를 짜야하는지요. 그리고 하단의 array 데이터를 App.vue의 data안에 저장해봅시다. Q2. 그 다음 이걸 List.vue안에 꽂아넣고싶으면 어떻게 코드를 짜야할까요? 물론 데이"
permalink: "2021/09/27/Vue-기본정리-part2"
---
<!-- ---
