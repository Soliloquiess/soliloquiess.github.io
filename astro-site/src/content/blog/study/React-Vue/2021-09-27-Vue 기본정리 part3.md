...
category: "React-Vue"
tags: ["React-Vue"]
description: "뷰 인스타그램 프로젝트 생성 & 레이아웃 만들기 오늘의 1시간 숙제 : 하단에 인스타그램 포스팅 데이터 3개를 첨부했습니다. 이걸 App.vue에 데이터로 보관하신 후 Post.vue에 데이터바인딩해서 3개의…"
...
그러면 이제 위에가서  이렇게 쉽게 state를 꺼내쓸 수 있는 것입니다.
