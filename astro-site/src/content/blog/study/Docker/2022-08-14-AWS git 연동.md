...
category: "Docker"
tags: ["AWS&Docker"]
description: "AWS상에서 GIT CLONE을 하게 되면(깃을 사용하게 되면) 인증을 하라고 문구가 뜬다. 근데 21년 8월부터 토큰키 형식으로 이미 다 바뀌었기 떄문에 별도로 설정해 줘야한다. 1.실제로 깃에서 연동하고 뭐…"
permalink: "study/2022/08/13/AWS-git-연동"
---
