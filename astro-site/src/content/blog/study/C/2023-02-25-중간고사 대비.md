...
category: "C"
tags: []
description: "약한 타입(js) 아뇨 = 강한 타입(C,C++, java 등, C 은 약한 타입도 지원) 일반적으로 상용 코드를 작성할 때는 강한 타입언어들이 실수할 부분이 적다. 매니지드 언어, 언매니지드 언어 메모리 수명(라이"
permalink: "2023/02/25/중간고사-대비"
---
<!-- ---
layout: post
title: "중간고사 대비"
