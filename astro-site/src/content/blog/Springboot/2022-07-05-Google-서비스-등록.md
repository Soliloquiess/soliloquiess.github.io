...
category: "Springboot"
tags: ["Springboot"]
description: "Google api를 사용하기 위한 서비스 등록 여기로 들어간다. 들어가면 위와 같은 화면이 있다. 저 API는 이전에 이미 만들어 둔 API 원래라면 맨 처음에는 API 및 서비스로 생성해야한다. 사용자…"
permalink: "study/2022/07/05/Google-서비스-등록"
---
