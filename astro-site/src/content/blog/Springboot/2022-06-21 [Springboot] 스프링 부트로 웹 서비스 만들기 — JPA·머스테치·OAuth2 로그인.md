---
title: "[Springboot] 스프링 부트로 웹 서비스 만들기 — JPA·머스테치·OAuth2 로그인"
date: 2022-06-21
category: "Springboot"
tags: ["Springboot"]
description: "스프링 부트로 게시판 웹 서비스를 만드는 실습 — IntelliJ·Gradle 세팅, JUnit TDD, JPA·Spring Data JPA, 머스테치 서버 사이드 템플릿, 스프링 시큐리티 구글 OAuth2 로그인까지 단계별로 정리."
        ...
        <div class="row">
            <div class="col-md-6">
                <a href="/posts/save" role="button" class="btn btn-primary">글 등록</a>
                    ...
                    Looged in as : <span id="user"></span>
